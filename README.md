...
### Setup Steps:
1. Created S3 bucket: `asst3hrush` in `us-east-2` region
...
![alt text](<Screenshots/S3 Structure.png>)
...
![alt text](<Screenshots/IAM Roles.png>)
...
- **Data Source:** `s3://asst3hrush/processed/`
...
![alt text](<Screenshots/Crawler2.png>)
...
- **Database:** `orders_db`
- **Table:** `processed`
- **Query Result Location:** `s3://asst3hrush/enriched/`
...
- **S3 Output Location:** s3://asst3hrush/enriched/
